<div class="container">
  <div class="card-panel white z-depth-3" style="margin-top: 40px; border-radius: 12px;">
    <h5 class="center-align">Formulir Pemuda Berprestasi</h5>
    <form id="formPemudaBerprestasi" class="row">
     
      <div class="input-field col s12">
        <input id="nama" name="nama" type="text" class="validate" required>
        <label for="nama">Nama <span class="red-text">*</span> <span class="red-text">*</span></label>
      </div>
      <div class="input-field col s12 m6">
        ...
        <label>Jenis Kelamin <span class="red-text">*</span> <span class="red-text">*</span></label>
      </div>
      ...
      <div class="input-field col s12 m6">
        ...
        <label for="tempat_lahir">Tempat Lahir <span class="red-text">*</span> <span class="red-text">*</span></label>
      </div>
      <div class="input-field col s12 m6">
        <input id="tanggal_lahir" name="tanggal_lahir" type="date">
        <label for="tanggal_lahir">Tanggal Lahir <span class="red-text">*</span> <span class="red-text">*</span></label>
      </div>
    
      <div class="input-field col s12 m6">
        <input id="nik" name="nik" type="text" class="validate" required>
        <label for="nik">NIK <span class="red-text">*</span> <span class="red-text">*</span></label>
      </div>
      <div class="input-field col s12">
        <textarea id="alamat_ktp" name="alamat_ktp" class="materialize-textarea"></textarea>
        <label for="alamat_ktp">Alamat sesuai KTP <span class="red-text">*</span> <span class="red-text">*</span></label>
      </div>

      <div class="input-field col s12">
        <textarea id="alamat_domisili" name="alamat_domisili" class="materialize-textarea"></textarea>
        <label for="alamat_domisili">Alamat Domisili Kota Serang <span class="red-text">*</span> <span class="red-text">*</span></label>
      </div>
      <div class="input-field col s12 m6">
      ...
      <div class="input-field col s12">
        <input id="nama_prestasi" name="nama_prestasi" type="text">
        <label for="nama_prestasi">Nama Prestasi <span class="red-text">*</span></label>
      </div>

      <div class="input-field col s12">
        <input id="peringkat" name="peringkat" type="text">
        <label for="peringkat">Peringkat <span class="red-text">*</span></label>
      </div>

      <div class="input-field col s12">
        <input id="penyelenggara" name="penyelenggara" type="text">
        <label for="penyelenggara">Penyelenggara <span class="red-text">*</span></label>
      </div>

      <div class="input-field col s12">
        <input id="tahun_prestasi" name="tahun_prestasi" type="number" min="1900" max="2099" step="1">
        <label for="tahun_prestasi">Tahun Prestasi(1900-2099) <span class="red-text">*</span></label>
      </div>
      ...
      <div class="center-align">
        <div class="btn waves-effect waves-light blue white-text" onclick="saveDataPemudaBerprestasi()">
          Kirim
...
<script>
  ...
  function saveDataPemudaBerprestasi(){
    let form = document.getElementById("formPemudaBerprestasi");
    ...
    $.ajax({
      url: '<?php echo $URL; ?>/API/savePemudaBerprestasiStaging',
      method: 'POST',
      processData: false,
      contentType: false,
      cache: false,
