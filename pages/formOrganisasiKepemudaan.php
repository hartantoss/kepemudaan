<div class="container">
  <div class="card-panel white z-depth-3" style="margin-top: 40px; border-radius: 12px;">
    <h5 class="center-align">Formulir Organisasi Kepemudaan</h5>
    <form id="formOrganisasiKepemudaan" class="row">
      ...
      <div class="input-field col s12">
        ...
        <label for="jumlah_anggota">Jumlah Anggota Organisasi <span class="red-text">*</span></label>
      </div>
      ...
      <div class="input-field col s12">
        ...
        <label for="tanggal_berdiri">Tanggal Berdiri Organisasi <span class="red-text">*</span></label>
      </div>

      <div class="input-field col s12">
        <textarea id="alamat_sekretariat" name="alamat_sekretariat" class="materialize-textarea"></textarea>
        <label for="alamat_sekretariat">Alamat Sekretariat <span class="red-text">*</span></label>
      </div>
      <div class="input-field col s12 m6">
      ...
      <div class="center-align">
        <div class="btn waves-effect waves-light blue white-text" onclick="saveDataOrganisasiKepemudaan()">
          Kirim
...
<script>
  ...
  function saveDataOrganisasiKepemudaan(){
    let form = document.getElementById("formOrganisasiKepemudaan");
    ...
    $.ajax({
      url: '<?php echo $URL; ?>/API/saveOrganisasiKepemudaanStaging',
      method: 'POST',
      processData: false,
      contentType: false,
      cache: false,
