<div class="container">
  <div class="card-panel white z-depth-3" style="margin-top: 40px; border-radius: 12px;">
    <h5 class="center-align">Formulir Pemuda Pelopor</h5>
    <form id="formPemudaPelopor" class="row">
      ...
      <div class="input-field col s12">
        <input id="nama_kepeloporan" name="nama_kepeloporan" type="text">
        <label for="nama_kepeloporan">Nama Kepeloporan <span class="red-text">*</span></label>
      </div>
      ...
      <div class="input-field col s12 m6">
        <select name="bidang_kepeloporan" id="bidang_kepeloporan">
          ...
          <option value="Pengelolaan Lingkungan, SDA, dan Pariwisata">Pengelolaan Lingkungan, SDA, dan Pariwisata</option>
        </select>
        <label>Bidang Kepeloporan <span class="red-text">*</span></label>
      </div>

      <div class="input-field col s12 m6">
        <input id="tahun_mulai_pelopor" name="tahun_mulai_pelopor" type="number" min="1900" max="2099" step="1">
        <label for="tahun_mulai_pelopor">Tahun Mulai dilaksanakan Pelopor(1900-2099) <span class="red-text">*</span></label>
      </div>

      <div class="input-field col s12">
        <input id="deskripsi" name="deskripsi" type="text">
        <label for="deskripsi">Deskripsi Singkat Mengenai Kepeloporann Terkini <span class="red-text">*</span></label>
      </div>
      <div class="row">
          <p>Upload File Portofolio Kepeloporan <i>(Tidak Wajib)</i></p>
      ...
      <div class="center-align">
        <div class="btn waves-effect waves-light blue white-text" onclick="saveDataPemudaPelopor()">
          Kirim
...
<script>
  ...
  function saveDataPemudaPelopor(){
    let form = document.getElementById("formPemudaPelopor");
    ...
    $.ajax({
      url: '<?php echo $URL; ?>/API/savePemudaPeloporStaging',
      method: 'POST',
      processData: false,
      contentType: false,
      cache: false,
